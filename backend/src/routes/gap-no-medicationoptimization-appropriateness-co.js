...
const FEATURE_SLUG = 'no-medicationoptimization-appropriateness-co';
const FEATURE_TITLE = 'No /medication-optimization (appropriateness, cost, side effects)';
const PROJECT = 'AIRemotePatientMonitoring';
