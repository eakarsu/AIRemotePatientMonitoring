...
export default function GapNoMentalhealthscreeningPhq9Gad7Automatio() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mentalhealthscreening-phq9-gad7-automatio', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No /mental-health-screening (PHQ-9, GAD-7 automation)</h1>
