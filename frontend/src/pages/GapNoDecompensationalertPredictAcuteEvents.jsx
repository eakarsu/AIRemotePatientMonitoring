...
export default function GapNoDecompensationalertPredictAcuteEvents() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-decompensationalert-predict-acute-events', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No /decompensation-alert (predict acute events 48-72h ahead)</h1>
